...
import { Search, Send, Paperclip, MoreVertical, Menu, X } from "lucide-react";
        ...
        <>
            <ProtectedRoute>
                ...
                <div className="bg-black text-white min-h-screen flex flex-col md:flex-row pt-16">
                    {/* Sidebar */}
                    <aside
                        className={`fixed md:static top-16 left-0 h-[calc(100vh-64px)] w-72 bg-gray-950 border-r border-gray-800 flex flex-col transform transition-transform duration-300 z-40
          ${sidebarOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}
                    >
                        <div className="p-4 border-b border-gray-700 flex justify-between items-center">
                            <div className="flex items-center bg-gray-900 rounded-lg px-3 py-2 flex-1">
                            ...
                            <button className="md:hidden ml-3" onClick={() => setSidebarOpen(false)}>
                                <X size={20} />
                            </button>
                        </div>
                        <div className="flex-1 overflow-y-auto">
                            {chats.map((chat) => (
                                <div
                                    ...
                                    className={`flex items-center gap-3 p-4 cursor-pointer hover:bg-gray-900 transition ${selectedChat?.id === chat.id ? "bg-gray-900 border-l-4 border-purple-600" : ""
                                        }`}
                                >
                    ...
                    <main className="flex-1 flex flex-col h-[calc(100vh-64px)]">
                        {selectedChat ? (
                            <>
                                ...
                                <div className="flex items-center justify-between p-4 border-b border-gray-700 bg-gray-950">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <img src={selectedChat.img} alt={selectedChat.name} className="w-10 h-10 rounded-full" />
                                        <div>
                                ...
                                <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-black">
                                    {selectedChat.messages.map((msg, index) => (
                                        ...
                                        >
                                            <div
                                                className={`max-w-[75%] px-4 py-2 rounded-xl shadow ${msg.sender === "You"
                                ...
                                {/* Input Bar */}
                                <div className="p-3 border-t border-gray-700 bg-gray-950 flex flex-wrap items-center gap-3">
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center text-gray-500">
                                <button
                                    className="md:hidden mb-4 bg-purple-600 px-4 py-2 rounded-lg"
