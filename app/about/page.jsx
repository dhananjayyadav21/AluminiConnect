...
export default function AboutPage() {
    ...
    return (
        <div className="bg-black text-gray-100 min-h-screen font-sans">
            ...
            {/*  Hero Section */}
            {/*  Hero Section */}
            <section className="relative min-h-[40vh] sm:min-h-[70vh] flex flex-col justify-center items-center overflow-hidden border-b border-white/10">
                {/* Abstract background */}
                ...
                <div className="relative z-10 w-full max-w-4xl px-6 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-white to-amber-400 drop-shadow-lg mb-6 py-2">
                        About EduNet Nexus
                    </h1>
                    <p className="text-gray-300 text-lg md:text-md max-w-3xl mx-auto animate-fadeIn delay-200 mb-10 leading-relaxed">
